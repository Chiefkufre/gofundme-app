...
class DefaultImpl(metaclass=ImplMeta):
    ...
    def _exec(
        ...
        if self.as_sql:
            ...
            return conn.execute(construct, multiparams)  # type: ignore[call-overload]
    ...
    def render_ddl_sql_expr(
        ...
        compile_kw = {"compile_kwargs": {"literal_binds": True, "include_table": False}}
        return str(
            expr.compile(dialect=self.dialect, **compile_kw)  # type: ignore[arg-type]
        )
