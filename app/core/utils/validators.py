...
def validate_title_on_update(title, description):
    """Validates the title and description lengths for an update.

    Raises:
        ValueError: If the title is less than 10 characters or the description is less than 20 characters.
    """
